...
```{r echo=FALSE, out.width='50%', out.height= '50%', fig.align='right', fig.cap= "Source: NASA SAR Handbook"}
...
```{r echo=FALSE, out.width= "75%", fig.align='center', fig.cap="Frequency and Wavelength of SAR (Source: NASA Earth Data)"}
...
NASA SAR Handbook (n.d.) <https://www.earthdata.nasa.gov/learn/backgrounders/what-is-sar>

Strozzi, T., Kouraev, A., Wiesmann, A., Wegmüller, U., Sharov, A. and Werner, C., 2008. Estimation of Arctic glacier motion with satellite L-band SAR data. Remote Sensing of Environment, 112(3), pp.636-645.
